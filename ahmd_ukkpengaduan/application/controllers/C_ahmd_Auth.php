...
class C_ahmd_Auth extends CI_Controller
{
	...
	public function index()
	{
		...
		if ($this->form_validation->run() == false) {
			...
			$this->load->view('auth/v_ahmd_login');
		} else {
	...
	public function registrasi()
	{
		...
		if ($this->form_validation->run() == false) {
			...
			$this->load->view('auth/v_ahmd_registrasi');
		} else {
			$data = [
	...
	public function login_petugas()
	{
		...
		if ($this->form_validation->run() == false) {
			...
			$this->load->view('admin_auth/v_ahmd_loginadmin');
		} else {
	...
	public function _loginadmin()
	{
		...
		if ($petugas) {
			...
			Password Salah !
				...
				redirect('C_ahmd_Auth/login_petugas');
			}
		} else {
			$this->session->set_flashdata('message', '<div class="alert alert-danger" role="alert">
			Username tidak terdaftar !
	...
	public function registrasi_admin()
	{
		...
		$this->M_ahmd_Admin->insertPetugas($tambahPetugas);
		$this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Selamat anda sudah daftar, Silahkan login!</div>');
	...
	public function setup_admin()
	{
		...
		if ($this->form_validation->run() == false) {
			$this->load->view('admin_auth/v_ahmd_setupadmin');
		} else {
			...
			$this->M_ahmd_Admin->insertAdmin($tambahAdmin);
